...
EDATA_SIMPLE_DEFINE(dataStorage::DoubleLinkedList<unsigned int			>, DoLiLi)
EDATA_SIMPLE_DEFINE(dataStorage::DoubleLinkedList<long					>, DoLiLi)
EDATA_SIMPLE_DEFINE(dataStorage::DoubleLinkedList<unsigned long			>, DoLiLi)
EDATA_SIMPLE_DEFINE(dataStorage::DoubleLinkedList<long long				>, DoLiLi)
EDATA_SIMPLE_DEFINE(dataStorage::DoubleLinkedList<unsigned long long	>, DoLiLi)
EDATA_SIMPLE_DEFINE(dataStorage::DoubleLinkedList<float					>, DoLiLi)
EDATA_SIMPLE_DEFINE(dataStorage::DoubleLinkedList<double				>, DoLiLi)
EDATA_SIMPLE_DEFINE(dataStorage::DoubleLinkedList<long double			>, DoLiLi)
EDATA_SIMPLE_DEFINE(dataStorage::DoubleLinkedList<string				>, DoLiLi)
